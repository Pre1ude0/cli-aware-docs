...
description: Documentation for the Cli-Aware package 
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: "Detect cli clients and serve alternative responses depending on the environment." 
  image:
    file: ../../assets/houston.webp
  actions:
    - text: Introduction to Cli-Aware 
